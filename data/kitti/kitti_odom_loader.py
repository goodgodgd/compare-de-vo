...
class KittiOdomLoader(DataLoader):
    ...
    def collect_frames(self):
        self.num_train, self.train_frames = self.collect_split_frames(self.train_seqs)
        self.num_test,  self.test_frames  = self.collect_split_frames(self.test_seqs)

    def collect_split_frames(self, sequences):
        split_frames = []
        ...
        num_split = len(split_frames)
        return num_split, split_frames
